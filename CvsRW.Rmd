...
objectGroupBySubAgeSetCon <- group_by(objectList, subject, age, setsize,condition)
...
summarise(objectGroupAge,
          SetSizeTotal = mean(mean_answer_correct),
          ...
          falseAlarmRateTotal = mean(falseAlarmRate),
          ...
          K_6_Max = max(k[setsize == 6]),
          K_PTotal_mean = mean(kPashler),
          K_P2_mean = mean(kPashler[setsize == 2]),
          K_P4_mean = mean(kPashler[setsize == 4]),
          K_P6_mean = mean(kPashler[setsize == 6]),
          K_PTotal_median = median(kPashler),
          K_P2_median = median(kPashler[setsize == 2]),
          K_P4_median = median(kPashler[setsize == 4]),
          K_P6_median = median(kPashler[setsize == 6]),
          K_PTotal_Max = max(kPashler),
          K_P2_Max = max(kPashler[setsize == 2]),
          K_P4_Max = max(kPashler[setsize == 4]),
          K_P6_Max = max(kPashler[setsize == 6])) -> objectResultGroupAge

objectGroupAgeCon <- group_by(objectResultCondition, condition)
summarise(objectGroupAgeCon,
          ...
          K_P2_Max = max(kPashler[setsize == 2]),
          K_P4_Max = max(kPashler[setsize == 4]),
          K_P6_Max = max(kPashler[setsize == 6])) -> objectResultGroupAgeCondition
...
summarise(colorGroupAge,
          ...
          K_6_Max = max(k[condition == 6]),
          K_PTotal_mean = mean(kPashler),
          K_P2_mean = mean(kPashler[condition == 2]),
          K_P4_mean = mean(kPashler[condition == 4]),
          K_P6_mean = mean(kPashler[condition == 6]),
          K_PTotal_median = median(kPashler),
          K_P2_median = median(kPashler[condition == 2]),
          K_P4_median = median(kPashler[condition == 4]),
          K_P6_median = median(kPashler[condition == 6]),
          K_PTotal_Max = max(kPashler),
          K_P2_Max = max(kPashler[condition == 2]),
          K_P4_Max = max(kPashler[condition == 4]),
          K_P6_Max = max(kPashler[condition == 6])) -> colorResultGroupAge
...
colorResultGroupAge %>% select(age,SetSizeTotal,SetSize2,SetSize4,SetSize6,K_Total_mean,K_2_mean,K_4_mean,K_6_mean,K_PTotal_mean,K_P2_mean,K_P4_mean,K_P6_mean) -> df_Color_Compress
df_Color_Compress[2,-1] - df_Color_Compress[1,-1] -> df_Color_diff

colorResultGroupAge %>% select(age,SetSizeTotal,SetSize2,SetSize4,SetSize6,K_Total_mean,K_2_mean,K_4_mean,K_6_mean,K_PTotal_mean,K_P2_mean,K_P4_mean,K_P6_mean) %>% mutate_if(is.numeric, round,digits=2) %>% kable(caption = "Überblick Color Objekte Mittelwerte korrekte Antworten und K-Werte",align = "lcccccccccccr")

objectResultGroupAge %>% select(age,SetSizeTotal,SetSize2,SetSize4,SetSize6,K_Total_mean,K_2_mean,K_4_mean,K_6_mean,K_PTotal_mean,K_P2_mean,K_P4_mean,K_P6_mean) %>% mutate_if(is.numeric, round,digits=2) %>% kable(caption = "Überblick Real World Objekte Mittelwerte korrekte Antworten und K-Werte",align = "lcccccccccccr")

objectResultGroupAge %>% select(age,SetSizeTotal,SetSize2,SetSize4,SetSize6,K_Total_mean,K_2_mean,K_4_mean,K_6_mean,K_PTotal_mean,K_P2_mean,K_P4_mean,K_P6_mean) -> df_Object_Compress

df_Object_Compress[2,-1] - df_Object_Compress[1,-1] -> df_Object_diff

df_Color_diff %>% round(2) %>% kable(caption = "Abstand der Ergebnisse bei Color Objekten zwischen älteren Erwachsenen und jüngeren Erwachsenen",align = "lccccccccr")
df_Object_diff %>% round(2) %>% kable(caption = "Abstand der Ergebnisse bei Real World Objekten zwischen älteren Erwachsenen und jüngeren Erwachsenen",align = "lccccccccr")
df_Object_diff - df_Color_diff -> df_AltvsJung

df_AltvsJung %>% round(2) %>% kable(caption = "Abstand der Ergebnisse bei Color vs. Real World Objekten zwischen älteren Erwachsenen und jüngeren Erwachsenen",align = "lccccccccr")
```
...
Prüfung einer Änderung durch Condition

```{r}
objectResultGroupAgeCondition %>% select(Condition=condition_text,Answer_Correct=SetSizeTotal,K=K_Total_mean,K_pashler=K_PTotal_mean,Kmax=K_Total_Max,KPmax=K_PTotal_Max) %>% mutate_if(is.numeric, round,digits=2) %>% kable(caption = "Überblick Versuchsreihe Real World Objects K",align = "lccccr")
objectResultGroupAgeCondition %>% select(Condition=condition_text,SetSize=SetSizeTotal,K=K_Total_mean,K_pashler=K_PTotal_mean,Kmax=K_Total_Max,KPmax=K_PTotal_Max) %>% mutate_if(is.numeric, round,digits=2) -> objectCondition

p1 <- ggplot(objectCondition, aes(x = Condition,y=SetSize))+geom_col()+scale_y_continuous(labels = scales::percent)+labs(title="Answer Correct",subtitle = "Ergebnisse je Condition", x="Condition", y="Mittelwert Richtige Antworten")+geom_text(aes(label=paste0(scales::percent(SetSize,0.01))),position = position_stack(vjust = 1.05),size=3)

p2 <- ggplot(objectCondition, aes(x = Condition,y=K))+geom_col()+labs(title="K",subtitle = "Ergebnisse je Condition", x="Condition", y="Mittelwert K-Wert")+geom_text(aes(label=K_pashler),position = position_stack(vjust = 1.05),size=3)
p3 <- ggplot(objectCondition, aes(x = Condition,y=K_pashler))+geom_col()+labs(title="K-Pashler",subtitle = "Ergebnisse je Condition", x="Condition", y="Mittelwert K-Pashler Wert")+geom_text(aes(label=K_pashler),position = position_stack(vjust = 1.05),size=3)
